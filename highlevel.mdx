...
[![Watch the video](https://img.youtube.com/vi/LLImFkFbKo8/0.jpg)](https://www.youtube.com/watch?v=LLImFkFbKo8)
...
Get the User ID from the "Profile Settings" in Samurai. Add the `user_id` to custom values.

### Step 5: Complete Samurai AI Setup - Step 1

Head to the form called "Samurai AI Setup - Step 1" in your Highlevel account in the "forms" section. Open the form, make sure that you have the required fields added, and click the button to complete the setup. This part of the setup creates a workspace and the assistants in Samurai.

...
4. Copy the `connection_id` and paste it as the "Custom Value" in Highlevel.

### Step 4: Highlevel CRM Setup

1. Create a Highlevel Account [Create a Highlevel account here](https://app.gohighlevel.com/).
2. Download the snapshot [here](https://affiliates.gohighlevel.com/?fp_ref=45jgr&share=iJfS0OiKt2A7bt7eDjzO). The snapshot will create:

...
### Step 6: Complete Samurai AI Setup Form

Head to the form called "Samurai AI Setup" in your Highlevel account. Open the form, make sure that you have the required fields added, and click the button to complete the setup.
